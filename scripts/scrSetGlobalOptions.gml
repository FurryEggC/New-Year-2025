...
//window_set_size(800*2,608*2);  // REMEMBER to "//"
...
global.roomCaptionDef = "New Year 2025";  //sets default window caption (only works with the Professional version of Studio)
global.roomCaptionLast = global.roomCaptionDef;
window_set_caption(global.roomCaptionDef);

global.md5StrAdd = "New Year 2025";  //sets what to add to the end of md5 input string to make the save harder to mess with, can be changed to anything, should be set to something unique and hard to predict (like setting a password)

global.startRoom = rBegining;    //sets which room to begin with
...
global.secretItemTotal = 16;     //sets how many secret items for the game to save/load
